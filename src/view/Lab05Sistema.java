...
public class Lab05Sistema {
	...
	public void execCadastramento() {
		...
		if (cad.equalsIgnoreCase("s")){
            if (agencia >=5000){
                ...
                Lab05ContaCorrenteEspecial myContaeEspecial = 
                        new Lab05ContaCorrenteEspecial(agencia,conta,nome,saldo,limite);
                myContaeEspecial.gravar();
	...
	public void execSaque() {
		...
		if (saq.equalsIgnoreCase("s")){
            Lab03ContaCorrente myConta; // polimorfismo
            
            if (agencia >= 5000) {
                myConta = new Lab05ContaCorrenteEspecial(agencia, conta);
            } else {
                myConta = new Lab03ContaCorrente(agencia, conta);
            }
